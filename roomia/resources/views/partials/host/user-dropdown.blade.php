...
<li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu dropdown-menu-end shadow-sm">
        ...
        {{-- Dashboard --}}
        <li>
            <a class="dropdown-item d-flex align-items-center gap-2" href="{{ route('host.dashboard') }}">
        ...
        <li>
            <a class="dropdown-item d-flex align-items-center gap-2" href="{{ route('host.profile.edit') }}">
